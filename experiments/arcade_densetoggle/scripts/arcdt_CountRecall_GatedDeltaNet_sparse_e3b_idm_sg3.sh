#!/usr/bin/env bash
# AUTO-GENERATED. Arcade density toggle: CountRecall / GatedDeltaNet / sparse /
# e3b_idm at seeds {3 4} — one condition, seeds in PARALLEL on one GPU
...
TASK="CountRecall"; CELL="GatedDeltaNet"; DENSITY="sparse"; INTR="e3b_idm"
