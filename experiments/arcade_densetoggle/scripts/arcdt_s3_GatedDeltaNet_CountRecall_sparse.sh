#!/usr/bin/env bash
# AUTO-GENERATED. Arcade density toggle: CountRecall / GatedDeltaNet / sparse at
# seed 3 — runs {none, e3b_idm} in PARALLEL on one GPU (84x84 parity
...
TASK="CountRecall"; CELL="GatedDeltaNet"; DENSITY="sparse"; SEED="3"
