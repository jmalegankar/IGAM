#!/usr/bin/env bash
# AUTO-GENERATED. MortarMayhem density toggle: GatedDeltaNet / sparse at seed
# 3 — runs {none, e3b_idm} in PARALLEL on one GPU (84x84 pixel pair).
set -euo pipefail
...
CELL="GatedDeltaNet"; DENSITY="sparse"; SEED="3"
