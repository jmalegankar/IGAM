...
# MysteryPath HP-sweep: GatedDeltaNet_none_ck128_lr0p00025 (e3b_idm). Honors PYTHON DEVICE RUNS_DIR SEEDS
...
CFG="$HERE/../configs/mpg_hp_GatedDeltaNet_none_ck128_lr0p00025.yaml"
LOGDIR="$HERE/../_logs"; mkdir -p "$LOGDIR"
TAG="GatedDeltaNet_none_ck128_lr0p00025"
