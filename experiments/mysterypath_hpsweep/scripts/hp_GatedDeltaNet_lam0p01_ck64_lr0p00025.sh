...
# MysteryPath HP-sweep: GatedDeltaNet_lam0p01_ck64_lr0p00025 (e3b_idm). Honors PYTHON DEVICE RUNS_DIR SEEDS
...
CFG="$HERE/../configs/mpg_hp_GatedDeltaNet_lam0p01_ck64_lr0p00025.yaml"
LOGDIR="$HERE/../_logs"; mkdir -p "$LOGDIR"
TAG="GatedDeltaNet_lam0p01_ck64_lr0p00025"
