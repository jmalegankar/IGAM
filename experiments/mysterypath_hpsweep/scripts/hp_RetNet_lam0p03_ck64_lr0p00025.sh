...
# MysteryPath HP-sweep: RetNet_lam0p03_ck64_lr0p00025 (e3b_idm). Honors PYTHON DEVICE RUNS_DIR SEEDS
...
CFG="$HERE/../configs/mpg_hp_RetNet_lam0p03_ck64_lr0p00025.yaml"
LOGDIR="$HERE/../_logs"; mkdir -p "$LOGDIR"
TAG="RetNet_lam0p03_ck64_lr0p00025"
