...
# MysteryPath HP-sweep: GatedDeltaNet_lam0p03_ck32_lr0p0001 (e3b_idm). Honors PYTHON DEVICE RUNS_DIR SEEDS
...
CFG="$HERE/../configs/mpg_hp_GatedDeltaNet_lam0p03_ck32_lr0p0001.yaml"
LOGDIR="$HERE/../_logs"; mkdir -p "$LOGDIR"
TAG="GatedDeltaNet_lam0p03_ck32_lr0p0001"
