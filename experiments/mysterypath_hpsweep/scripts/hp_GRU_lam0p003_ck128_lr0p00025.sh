...
# MysteryPath HP-sweep: GRU_lam0p003_ck128_lr0p00025 (e3b_idm). Honors PYTHON DEVICE RUNS_DIR SEEDS
...
CFG="$HERE/../configs/mpg_hp_GRU_lam0p003_ck128_lr0p00025.yaml"
LOGDIR="$HERE/../_logs"; mkdir -p "$LOGDIR"
TAG="GRU_lam0p003_ck128_lr0p00025"
