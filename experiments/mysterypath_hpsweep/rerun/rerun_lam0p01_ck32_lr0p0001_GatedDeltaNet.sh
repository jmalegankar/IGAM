#!/usr/bin/env bash
# RERUN of failed HP combo lam0p01_ck32_lr0p0001 — cells [GatedDeltaNet] in parallel on ONE GPU
...
CELLS="GatedDeltaNet"
echo "[rerun lam0p01_ck32_lr0p0001 | GatedDeltaNet] cells=[$CELLS] on one GPU"
pids=()
...
[[ "$fail" == "0" ]] || { echo "[rerun lam0p01_ck32_lr0p0001 | GatedDeltaNet] a cell FAILED"; exit 1; }
echo "[rerun lam0p01_ck32_lr0p0001 | GatedDeltaNet] done."
