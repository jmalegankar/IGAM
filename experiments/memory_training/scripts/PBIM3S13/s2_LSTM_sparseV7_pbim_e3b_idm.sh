#!/usr/bin/env bash
# AUTO-GENERATED (PBIM3S13). LSTM/sparseV7/pbim_e3b_idm seed 2 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/PBIM3S13/LSTM_sparseV7_pbim_e3b_idm.yaml"
echo "[PBIM3S13] LSTM/sparseV7/pbim_e3b_idm seed=2"
