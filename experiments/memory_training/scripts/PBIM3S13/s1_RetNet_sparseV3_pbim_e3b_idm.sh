#!/usr/bin/env bash
# AUTO-GENERATED (PBIM3S13). RetNet/sparseV3/pbim_e3b_idm seed 1 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/PBIM3S13/RetNet_sparseV3_pbim_e3b_idm.yaml"
echo "[PBIM3S13] RetNet/sparseV3/pbim_e3b_idm seed=1"
