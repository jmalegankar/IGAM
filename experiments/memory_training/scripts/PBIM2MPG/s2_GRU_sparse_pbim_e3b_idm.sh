#!/usr/bin/env bash
# AUTO-GENERATED (PBIM2MPG). GRU/sparse/pbim_e3b_idm seed 2 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/PBIM2MPG/GRU_sparse_pbim_e3b_idm.yaml"
echo "[PBIM2MPG] GRU/sparse/pbim_e3b_idm seed=2"
