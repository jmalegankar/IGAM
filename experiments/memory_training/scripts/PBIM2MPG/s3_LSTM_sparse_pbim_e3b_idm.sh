#!/usr/bin/env bash
# AUTO-GENERATED (PBIM2MPG). LSTM/sparse/pbim_e3b_idm seed 3 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/PBIM2MPG/LSTM_sparse_pbim_e3b_idm.yaml"
echo "[PBIM2MPG] LSTM/sparse/pbim_e3b_idm seed=3"
