#!/usr/bin/env bash
# AUTO-GENERATED (PBIM2S13). Mamba2/freezeV3/pbim_e3b_idm seed 1 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/PBIM2S13/Mamba2_freezeV3_pbim_e3b_idm.yaml"
echo "[PBIM2S13] Mamba2/freezeV3/pbim_e3b_idm seed=1"
