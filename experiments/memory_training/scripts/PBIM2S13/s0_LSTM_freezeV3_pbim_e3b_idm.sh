#!/usr/bin/env bash
# AUTO-GENERATED (PBIM2S13). LSTM/freezeV3/pbim_e3b_idm seed 0 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/PBIM2S13/LSTM_freezeV3_pbim_e3b_idm.yaml"
echo "[PBIM2S13] LSTM/freezeV3/pbim_e3b_idm seed=0"
