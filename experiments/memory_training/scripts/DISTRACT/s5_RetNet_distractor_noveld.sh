#!/usr/bin/env bash
# AUTO-GENERATED (DISTRACT). RetNet/distractor/noveld seed 5 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/DISTRACT/RetNet_distractor_noveld.yaml"
echo "[DISTRACT] RetNet/distractor/noveld seed=5"
