#!/usr/bin/env bash
# AUTO-GENERATED (DISTRACT). Memoryless/distractor/none seed 5 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/DISTRACT/Memoryless_distractor_none.yaml"
echo "[DISTRACT] Memoryless/distractor/none seed=5"
