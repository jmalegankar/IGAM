#!/usr/bin/env bash
# AUTO-GENERATED (DISTRACT). GatedDeltaNet/distractor/none seed 5 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/DISTRACT/GatedDeltaNet_distractor_none.yaml"
echo "[DISTRACT] GatedDeltaNet/distractor/none seed=5"
