#!/usr/bin/env bash
# AUTO-GENERATED (DISTRACT). Mamba2/distractor/none seed 9 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/DISTRACT/Mamba2_distractor_none.yaml"
echo "[DISTRACT] Mamba2/distractor/none seed=9"
