#!/usr/bin/env bash
# AUTO-GENERATED (DISTRACT). LSTM/distractor/none seed 5 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/DISTRACT/LSTM_distractor_none.yaml"
echo "[DISTRACT] LSTM/distractor/none seed=5"
