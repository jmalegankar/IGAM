#!/usr/bin/env bash
# AUTO-GENERATED (DISTRACT). RetNet/distractor/e3b_idm seed 5 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/DISTRACT/RetNet_distractor_e3b_idm.yaml"
echo "[DISTRACT] RetNet/distractor/e3b_idm seed=5"
