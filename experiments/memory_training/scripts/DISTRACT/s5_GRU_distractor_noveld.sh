#!/usr/bin/env bash
# AUTO-GENERATED (DISTRACT). GRU/distractor/noveld seed 5 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/DISTRACT/GRU_distractor_noveld.yaml"
echo "[DISTRACT] GRU/distractor/noveld seed=5"
