#!/usr/bin/env bash
# AUTO-GENERATED (DISTRACT). LSTM/distractor/noveld seed 9 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/DISTRACT/LSTM_distractor_noveld.yaml"
echo "[DISTRACT] LSTM/distractor/noveld seed=9"
