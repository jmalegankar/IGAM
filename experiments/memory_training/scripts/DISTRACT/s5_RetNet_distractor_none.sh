#!/usr/bin/env bash
# AUTO-GENERATED (DISTRACT). RetNet/distractor/none seed 5 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/DISTRACT/RetNet_distractor_none.yaml"
echo "[DISTRACT] RetNet/distractor/none seed=5"
