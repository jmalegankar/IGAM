#!/usr/bin/env bash
# AUTO-GENERATED (DISTRACT). GatedDeltaNet/distractor/noveld seed 9 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/DISTRACT/GatedDeltaNet_distractor_noveld.yaml"
echo "[DISTRACT] GatedDeltaNet/distractor/noveld seed=9"
