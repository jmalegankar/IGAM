#!/usr/bin/env bash
# AUTO-GENERATED (DISTRACT). Memoryless/distractor/e3b_idm seed 5 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/DISTRACT/Memoryless_distractor_e3b_idm.yaml"
echo "[DISTRACT] Memoryless/distractor/e3b_idm seed=5"
