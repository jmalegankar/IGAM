#!/usr/bin/env bash
# AUTO-GENERATED (MCPG). GatedDeltaNet/sparse/none seed 1 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/MCPG/GatedDeltaNet_sparse_none.yaml"
echo "[MCPG] GatedDeltaNet/sparse/none seed=1"
