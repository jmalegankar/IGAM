#!/usr/bin/env bash
# AUTO-GENERATED (MCPG). GRU/sparse/e3b_idm seed 0 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/MCPG/GRU_sparse_e3b_idm.yaml"
echo "[MCPG] GRU/sparse/e3b_idm seed=0"
