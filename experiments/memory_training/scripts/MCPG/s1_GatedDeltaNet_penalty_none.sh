#!/usr/bin/env bash
# AUTO-GENERATED (MCPG). GatedDeltaNet/penalty/none seed 1 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/MCPG/GatedDeltaNet_penalty_none.yaml"
echo "[MCPG] GatedDeltaNet/penalty/none seed=1"
