#!/usr/bin/env bash
# AUTO-GENERATED (MCPG). GatedDeltaNet/sparse/e3b_idm seed 1 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/MCPG/GatedDeltaNet_sparse_e3b_idm.yaml"
echo "[MCPG] GatedDeltaNet/sparse/e3b_idm seed=1"
