#!/usr/bin/env bash
# AUTO-GENERATED (MCPG). GRU/penalty/e3b_idm seed 2 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../configs/MCPG/GRU_penalty_e3b_idm.yaml"
echo "[MCPG] GRU/penalty/e3b_idm seed=2"
