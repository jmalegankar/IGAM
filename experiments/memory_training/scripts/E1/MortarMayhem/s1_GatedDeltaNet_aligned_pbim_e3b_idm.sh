#!/usr/bin/env bash
# AUTO-GENERATED (E1). GatedDeltaNet/aligned/pbim_e3b_idm seed 1 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../../configs/E1/MortarMayhem/GatedDeltaNet_aligned_pbim_e3b_idm.yaml"
echo "[E1] GatedDeltaNet/aligned/pbim_e3b_idm seed=1"
