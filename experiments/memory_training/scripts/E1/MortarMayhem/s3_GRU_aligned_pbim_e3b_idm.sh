#!/usr/bin/env bash
# AUTO-GENERATED (E1). GRU/aligned/pbim_e3b_idm seed 3 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../../configs/E1/MortarMayhem/GRU_aligned_pbim_e3b_idm.yaml"
echo "[E1] GRU/aligned/pbim_e3b_idm seed=3"
