#!/usr/bin/env bash
# AUTO-GENERATED (E1). RetNet/sparse/pbim_e3b_idm seed 4 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../../configs/E1/MortarMayhem/RetNet_sparse_pbim_e3b_idm.yaml"
echo "[E1] RetNet/sparse/pbim_e3b_idm seed=4"
