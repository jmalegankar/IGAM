#!/usr/bin/env bash
# AUTO-GENERATED (E1). LSTM/sparse/noveld seed 0 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../../configs/E1/MiniWorldSign/LSTM_sparse_noveld.yaml"
echo "[E1] LSTM/sparse/noveld seed=0"
