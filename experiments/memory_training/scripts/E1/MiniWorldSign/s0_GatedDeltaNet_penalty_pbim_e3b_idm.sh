#!/usr/bin/env bash
# AUTO-GENERATED (E1). GatedDeltaNet/penalty/pbim_e3b_idm seed 0 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../../configs/E1/MiniWorldSign/GatedDeltaNet_penalty_pbim_e3b_idm.yaml"
echo "[E1] GatedDeltaNet/penalty/pbim_e3b_idm seed=0"
