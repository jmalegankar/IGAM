#!/usr/bin/env bash
# AUTO-GENERATED (E1). Mamba2/sparse/noveld seed 2 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../../configs/E1/MiniWorldSign/Mamba2_sparse_noveld.yaml"
echo "[E1] Mamba2/sparse/noveld seed=2"
