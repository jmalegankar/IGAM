#!/usr/bin/env bash
# AUTO-GENERATED (E1). Memoryless/sparse/pbim_e3b_idm seed 0 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../../configs/E1/MiniWorldSign/Memoryless_sparse_pbim_e3b_idm.yaml"
echo "[E1] Memoryless/sparse/pbim_e3b_idm seed=0"
