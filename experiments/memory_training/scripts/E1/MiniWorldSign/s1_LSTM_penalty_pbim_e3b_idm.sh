#!/usr/bin/env bash
# AUTO-GENERATED (E1). LSTM/penalty/pbim_e3b_idm seed 1 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../../configs/E1/MiniWorldSign/LSTM_penalty_pbim_e3b_idm.yaml"
echo "[E1] LSTM/penalty/pbim_e3b_idm seed=1"
