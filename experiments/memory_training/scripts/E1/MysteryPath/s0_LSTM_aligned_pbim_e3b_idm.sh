#!/usr/bin/env bash
# AUTO-GENERATED (E1). LSTM/aligned/pbim_e3b_idm seed 0 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../../configs/E1/MysteryPath/LSTM_aligned_pbim_e3b_idm.yaml"
echo "[E1] LSTM/aligned/pbim_e3b_idm seed=0"
