#!/usr/bin/env bash
# AUTO-GENERATED (E1). GRU/penalty/pbim_e3b_idm seed 3 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../../configs/E1/MysteryPath/GRU_penalty_pbim_e3b_idm.yaml"
echo "[E1] GRU/penalty/pbim_e3b_idm seed=3"
