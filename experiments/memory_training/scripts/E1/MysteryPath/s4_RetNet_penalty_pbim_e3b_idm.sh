#!/usr/bin/env bash
# AUTO-GENERATED (E1). RetNet/penalty/pbim_e3b_idm seed 4 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../../configs/E1/MysteryPath/RetNet_penalty_pbim_e3b_idm.yaml"
echo "[E1] RetNet/penalty/pbim_e3b_idm seed=4"
