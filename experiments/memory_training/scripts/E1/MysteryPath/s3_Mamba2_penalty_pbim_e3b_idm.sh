#!/usr/bin/env bash
# AUTO-GENERATED (E1). Mamba2/penalty/pbim_e3b_idm seed 3 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../../configs/E1/MysteryPath/Mamba2_penalty_pbim_e3b_idm.yaml"
echo "[E1] Mamba2/penalty/pbim_e3b_idm seed=3"
