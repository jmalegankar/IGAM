#!/usr/bin/env bash
# AUTO-GENERATED (E1). Memoryless/sparseV7/pbim_e3b_idm seed 0 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../../configs/E1/S13/Memoryless_sparseV7_pbim_e3b_idm.yaml"
echo "[E1] Memoryless/sparseV7/pbim_e3b_idm seed=0"
