#!/usr/bin/env bash
# AUTO-GENERATED (E1). GatedDeltaNet/freezeV3/pbim_e3b_idm seed 3 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../../configs/E1/S13/GatedDeltaNet_freezeV3_pbim_e3b_idm.yaml"
echo "[E1] GatedDeltaNet/freezeV3/pbim_e3b_idm seed=3"
