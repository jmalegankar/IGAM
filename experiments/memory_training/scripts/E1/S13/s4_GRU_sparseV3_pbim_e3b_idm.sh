#!/usr/bin/env bash
# AUTO-GENERATED (E1). GRU/sparseV3/pbim_e3b_idm seed 4 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../../configs/E1/S13/GRU_sparseV3_pbim_e3b_idm.yaml"
echo "[E1] GRU/sparseV3/pbim_e3b_idm seed=4"
