#!/usr/bin/env bash
# AUTO-GENERATED (E1). GRU/sparseV7/pbim_e3b_idm seed 1 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../../configs/E1/S13/GRU_sparseV7_pbim_e3b_idm.yaml"
echo "[E1] GRU/sparseV7/pbim_e3b_idm seed=1"
