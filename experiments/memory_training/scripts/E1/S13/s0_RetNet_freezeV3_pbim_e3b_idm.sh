#!/usr/bin/env bash
# AUTO-GENERATED (E1). RetNet/freezeV3/pbim_e3b_idm seed 0 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../../configs/E1/S13/RetNet_freezeV3_pbim_e3b_idm.yaml"
echo "[E1] RetNet/freezeV3/pbim_e3b_idm seed=0"
