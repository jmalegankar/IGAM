#!/usr/bin/env bash
# AUTO-GENERATED (E1). Mamba2/sparseV3/pbim_e3b_idm seed 0 — ONE run / one GPU, snapshots ON.
set -euo pipefail
...
CFG="$HERE/../../../configs/E1/S13/Mamba2_sparseV3_pbim_e3b_idm.yaml"
echo "[E1] Mamba2/sparseV3/pbim_e3b_idm seed=0"
