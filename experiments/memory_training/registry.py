...
CORE = [
    ...
    EnvArm("TinyReproduce", "TinyReproduce-v0", "memrl-memtrain-tiny", TINY3,
           ["none", "e3b_idm"],
           [Density("sparse", env_kwargs={"k": 6, "v": 2, "order": "reverse", "density": "sparse"}),
            Density("dense", env_kwargs={"k": 6, "v": 2, "order": "reverse", "density": "dense"})],
           2_000_000,
           "α≈0 · FULLY ENUMERABLE RM (colleague's example) → exact eff-RM-size validation"),
