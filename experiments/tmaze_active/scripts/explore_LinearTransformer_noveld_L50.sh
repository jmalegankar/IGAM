...
# Active T-Maze: LinearTransformer + noveld at corridor length L=50, all seeds.
...
CFG="$HERE/../configs/tmaze_active_LinearTransformer_noveld_L50.yaml"
LOGDIR="$HERE/../_logs"; mkdir -p "$LOGDIR"
TAG="LinearTransformer_noveld_L50"
