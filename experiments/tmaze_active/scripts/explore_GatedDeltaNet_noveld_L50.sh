...
# Active T-Maze: GatedDeltaNet + noveld at corridor length L=50, all seeds.
...
CFG="$HERE/../configs/tmaze_active_GatedDeltaNet_noveld_L50.yaml"
LOGDIR="$HERE/../_logs"; mkdir -p "$LOGDIR"
TAG="GatedDeltaNet_noveld_L50"
