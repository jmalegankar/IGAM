...
# Active T-Maze: GatedDeltaNet + e3b_idm at corridor length L=50, all seeds.
...
CFG="$HERE/../configs/tmaze_active_GatedDeltaNet_e3b_idm_L50.yaml"
LOGDIR="$HERE/../_logs"; mkdir -p "$LOGDIR"
TAG="GatedDeltaNet_e3b_idm_L50"
