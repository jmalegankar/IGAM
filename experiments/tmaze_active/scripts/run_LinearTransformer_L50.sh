...
# Active T-Maze: LinearTransformer + none at corridor length L=50, all seeds.
...
CFG="$HERE/../configs/tmaze_active_LinearTransformer_none_L50.yaml"
LOGDIR="$HERE/../_logs"; mkdir -p "$LOGDIR"
TAG="LinearTransformer_none_L50"
